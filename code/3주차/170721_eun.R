...
data_2012_05_08$YPOINT_WGS <- droplevels(data_2012_05_08$YPOINT_WGS) # 메타데이터 지우기
data_2012_05_08$XPOINT_WGS <- droplevels(data_2012_05_08$XPOINT_WGS)
data_2012_05_08$YPOINT_WGS <- as.character(data_2012_05_08$YPOINT_WGS) # char로 변환 후 num으로 해줘야 소수점 안없어짐
